...
export function useDalayWatch<T>(watchRef: (watchRef: WatchSource) => void, callback: (newState: T, oldState: T) => void, interval = 1000, options?: WatchOptions | false, syncCallback?: ((newState: T, oldState: T) => void) | undefined): ReturnType<typeof watch> {
