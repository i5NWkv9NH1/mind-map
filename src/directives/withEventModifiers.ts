...
import { capitalize, withKeys, withModifiers } from 'vue'
...
export function resolveEventModifiers({
  eventName,
  eventModifiers,
}: {
  eventName: string
...
export function withEventModifiers(eventObject: object, modifiers: string[]) {
